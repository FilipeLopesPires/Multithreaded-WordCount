 ...
 *
 *  \brief Multi-threaded implementation of the program that computes the circular cross-correlation of the values of two signals.
 *
 ...
 * 
 *  Main function of the 'signalCrossCorrelation' program responsible for creating worker threads and managing the monitor for delivering the desired results.
